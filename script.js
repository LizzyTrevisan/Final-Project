document.getElementById('quoteForm').addEventListener('submit', function (e) {
  ...
  document.getElementById('cash-price').innerText = `$${price.toFixed(2)} per visit`;
  document.getElementById('card-price').innerText = `$${(price + 5).toFixed(2)} per visit`;
  document.getElementById('stripe-price').innerText = `$${(price + 10).toFixed(2)} per visit`;
  document.getElementById('paypal-price').innerText = `$${(price + 10).toFixed(2)} per visit`;
});
